    ...
    >
      ...
      >
        ...
        {cartItems?.length === 0 ? (
          ...
          <div>
            <div className="flex items-start justify-start flex-col gap-y-7 lg:gap-y-5  overflow-y-scroll h-[72vh] scroll-smooth scroll-hidden py-3">
            ...
            <div
              className=" fixed bottom-0 bg-white w-full px-5py2
             grid items-center "
            >
