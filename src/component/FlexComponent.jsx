      ...
      >
        <div className="max-w-lg  lg:max-w-none w-full md:text-center grid items-center lg:justify-items-center ">
          ...
          >
            <button
              type="button"
              className=" button-theme bg-slate-900 shadow-slate-900 text-slate-100 py-1.5 hover:scale-105 duration-200 mb-5"
            >
              {btn}
            </button>
          </a>
          ...
          <img
            ...
            className={`w-auto object-fill transitions-theme ${
              ifExist
                ...
                : "h-72 lg:h-64 md:h-60 sm:h-48 xsm:h-40 rotate-[14deg] hover:-rotate-[0deg]"
            }`}
          />
        </div>
      </div>
